...
export default function User() {
    ...
    return <>
        ...
        <main className="main">
            {/* ======================================== */}
            <div className={style.title}>個人</div>
            ...
            {/* ======================================== */}
            <div className={style.title}>賣場</div>
            <div className={style.container}>
                <Link to={`/Store/${account}#refresh`}>
